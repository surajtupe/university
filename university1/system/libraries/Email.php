...
class CI_Email {
	...
	var	$smtp_host		= "mail.panaceatek.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "suraj@panaceatek.com";		// SMTP Username
	var	$smtp_pass		= "surajtupe@ai9";		// SMTP Password
	...
	public function subject($subject)
	{
		...
		$subject=rtrim(str_replace("\r", "", $subject));;
