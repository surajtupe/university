...
<script>
    $(document).ready(function() {
        var login_user_step = '<?php echo $arr_user_details['user_step'] ?>';

        if (login_user_step == '1') {
            $('#second_step').show();
            document.title = "Profile";
            window.location.hash = "profile";
        } else if (login_user_step == '2') {
            $('#current_address_step').show();
            $('#back_btn_curr_add').hide();
            document.title = "Current Address";
            window.location.hash = "current-address";
        } else if (login_user_step == '3') {
            $('#permanent_address_step').show();
        ...
        <div class="mid-section">
            ...
            <form id="frm_complete_profile" name="frm_complete_profile" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="text-center offset-top-25 offset-bot-15">
                    <input type="hidden" name="last_inser_id" id="last_inser_id" value="<?php echo $user_id ?>">
                    <input type="hidden" name="phone_number" id="phone_number" value="<?php echo $arr_user_details['phone_number'] ?>">
    ...
    <div class="container">
        <div class="mid-section">
            ...
            <form class="form-horizontal" id="frm_current_address" name="frm_current_address" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="ft-box">
                    <input type="hidden" id="c_last_inser_id" name="c_last_inser_id" value="<?php echo $user_id ?>">
    ...
    <div class="container">
        <div class="mid-section">
            ...
            <form class="form-horizontal" id="frm_permanent_address" name="frm_permanent_address" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="buliding-photo">
                        <div class="build-img">
                            <a href="javascript:void(0);"> 
                                ...
                                <?php if (isset($arr_current_add_details['address_picture']) && $arr_current_add_details['address_picture'] != '') { ?>
                                    <img src="<?php echo base_url() ?>media/front/img/address-picture/thumbs/<?php echo $arr_current_add_details['address_picture'] ?>" class="current_add_img1" style="display: none" onerror="src='<?php echo base_url() ?>media/front/img/add-img.png'"/>
                                <?php } ?> 
                            </a>
                ...
                <div class="ft-box">
                    <input type="hidden" id="p_last_inser_id" name="p_last_inser_id" value="<?php echo $user_id ?>">
                    <input type="hidden" id="permanent_address_id_bk" name="permanent_address_id_bk" value="">
                    <input type="hidden" id="current_address_id" name="current_address_id" value="">
                    <input type="hidden" id="current_address_image" name="current_address_image" value="<?php echo (isset($arr_current_add_details['address_picture']) && $arr_current_add_details['address_picture'] != '') ? $arr_current_add_details['address_picture'] : '' ?>">
    ...
    <div class="container">
        <div class="mid-section">
            ...
            <form class="form-horizontal" id="frm_office_address" name="frm_office_address" method="post" action="">
                ...
                <div class="ft-box">
                    <input type="hidden" id="o_last_inser_id" name="o_last_inser_id" value="<?php echo $user_id ?>">
...
<?php if (isset($arr_current_add_details) && $arr_current_add_details != '') { ?>
            current_add_country = '<?php echo $arr_current_add_details['country_id'] ?>';
            current_add_state = '<?php echo $arr_current_add_details['state_id'] ?>';
            current_add_city = '<?php echo $arr_current_add_details['city_id'] ?>';
            current_add_zipcode = '<?php echo $arr_current_add_details['zip_code'] ?>';
            current_add_first = '<?php echo $arr_current_add_details['address_line1'] ?>';
            current_add_second = '<?php echo $arr_current_add_details['address_line2'] ?>';
            current_add_lat = '<?php echo $arr_current_add_details['latitude'] ?>';
            current_add_long = '<?php echo $arr_current_add_details['longitude'] ?>';
<?php } else { ?>
            current_add_country = $('#current_add_country').val();
            current_add_state = $('#current_add_state').val();
            current_add_city = $('#current_add_city').val();
            current_add_zipcode = $('#current_add_zipcode').val();
            current_add_first = $('#current_add_first').val();
            current_add_second = $('#current_add_second').val();
            current_add_lat = $('#current_add_lat').val();
            current_add_long = $('#current_add_long').val();
<?php } ?>
        if (this.checked) {
            $('#permanent_location_same_as_above').removeAttr('checked');
            $('#current_add_img_for_same_add').css('display', 'block');
            $('.current_add_img1').css('display', 'block');
            ...
            $('.current_add_img1').css('display', 'none');
...
////                var str = '';
////                str += '<div class="alert alert-danger" style="display: block"> Please enter valid zipcode.';
////                str += '<button class="close" id="msg_close" name="msg_close" data-dismiss="alert" type="button">x</button>';
////                str += '</div>';
////                $('.alert_msg_div').html(str);
//                $('#current_add_zipcode').val('');
////                $("#frm_current_address").submit(function(e) {
...
//            else {
//                $('#error_zipcode').text('');
//                $('#error_zipcode').text('Please enter valid zipcode.');
//                $('#error_zipcode').show();
////                var str = '';
////                str += '<div class="alert alert-danger" style="display: block"> Please enter valid zipcode.';
////                str += '<button class="close" id="msg_close" name="msg_close" data-dismiss="alert" type="button">x</button>';
...
//    }
//
//    function openFilePermanentAddress() {
//        document.getElementById("per_add_building_pic").click();
//    }
//
//    function openFileofficeAddress() {
//        document.getElementById("office_add_building_pic").click();
//    }
