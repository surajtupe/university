                        ...
                        <form name="frm_country" id="frm_country" action="<?php echo base_url(); ?>backend/delete-countries" method="post">
                            <div role="grid" class="dataTables_wrapper form-inline" id="example1_wrapper">									
                                <table class="table table-bordered table-striped dataTable" id="example1" aria-describedby="example1_info">
                                    ...
                                    <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"  aria-sort="ascending" aria-label="Country ISO">Country Phone Code</th>
                                    <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"  aria-sort="ascending" aria-label="Country ISO">Country Flag</th>
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($get_countries_list)) {
                                            ...
                                            <td><?php echo $country_phone_code; ?></td>
                                            <td><img src="<?php echo base_url() ?>media/backend/img/country-flag/thumbs/<?php echo $country_flag; ?>" onerror="src='<?php echo base_url()?>media/front/img/no-image.jpg'" width="120px" height="50px"></td>
