...
<aside class="right-side">
    ...
    <section class="content">
        ...
        <div class="col-md-12 infowthTab">
            <ul class="cstmTab clearfix">
                ...
                <li role="presentation" class="active"><a href="#office_address" aria-controls="office_address" role="tab" data-toggle="tab">Office Address</a></li>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="office_address">
                    <div class="row">
                        <div class="col-xs-12">
    ...
    <script type="text/javascript">
        ...
        var latitude = $('#office_location_lat').val();
        var longitude = $('#office_location_long').val();
        ...
        function initialize() {
            ...
            map = new google.maps.Map(document.getElementById("office_add_map"), mapOpt);
            var lat = latitude;
            var lng = longitude;
