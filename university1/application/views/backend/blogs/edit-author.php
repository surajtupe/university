            ...
            <div class="row-fluid sortable"> 
                ...
                <div class="box span12">
                    ...
                    <div class="box-content">
                        <div class="box-content">
                            <div>
                                <form name="frmForumPost" class="form-horizontal" id="frmForumPost" action="<?php echo base_url(); ?>backend/blog/edit-author/<?php echo $arr_cat_info["author_id"]; ?>" method="POST" >
                                    <div class="control-group"> 
                                        ...
                                        <div class="controls">
                                            <input type="text" dir="ltr"  class="FETextInput" name="inputName" value="<?php echo $arr_cat_info['author_name']; ?>" size="80"   />
                                        </div>
                                    </div>
                                    <div class="form-actions">
                                        <button type="submit" name="btnSubmit" class="btn btn-primary" value="Save changes">Save changes</button>
                                        <input type="hidden" name="edit_id" value="<?php echo $arr_cat_info["author_id"]; ?>">
                                    </div>
                                </form>
                            </div>
                        </div>
